    ...
    for key_no in 0..args.nb_key {
        ...
        for i in 0..4 {
            for j in 0.. 4 {
                ...
                tk_xor_tke1[(8 + i, j)]  ^= &e1_tks_difference[1][(i, j)];
                tk_xor_tke1[(12 + i, j)] ^= &e1_tks_difference[2][(i, j)];
                tk_xor_tke1[(16 + i, j)] ^= &e1_tks_difference[3][(i, j)];
                tk_xor_tke1[(20 + i, j)] ^= &e1_tks_difference[4][(i, j)];
                ...
                tk_xor_tke0_xor_tke1[(8 + i, j)]  ^= &e1_tks_difference[1][(i, j)];
                tk_xor_tke0_xor_tke1[(12 + i, j)] ^= &e1_tks_difference[2][(i, j)];
                tk_xor_tke0_xor_tke1[(16 + i, j)] ^= &e1_tks_difference[3][(i, j)];
                tk_xor_tke0_xor_tke1[(20 + i, j)] ^= &e1_tks_difference[4][(i, j)];
            }
        }
